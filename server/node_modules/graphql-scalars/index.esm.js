...
import { Kind as Kind$1 } from 'graphql/language/kinds';
import { GraphQLScalarType as GraphQLScalarType$1, Kind as Kind$2, GraphQLError as GraphQLError$1 } from 'graphql';
...
function BigIntFactory (name = 'BigInt') {
    return new GraphQLScalarType({
        ...
        parseLiteral(ast) {
            if (ast.kind === Kind$1.INT || ast.kind === Kind$1.FLOAT || ast.kind === Kind$1.STRING) {
...
const HSL$1 = new GraphQLScalarType$1({
    name: `HSL`,
    ...
    parseLiteral(ast) {
        if (ast.kind !== Kind$2.STRING) {
            throw new GraphQLError$1(`Can only validate strings as HSL colors but got a: ${ast.kind}`);
        }
...
const IBAN$1 = new GraphQLScalarType$1({
    name: `IBAN`,
